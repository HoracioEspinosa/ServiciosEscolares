var AppInbox = function () {
    ...
    var initWysihtml5 = function () {
        $('.inbox-wysihtml5').wysihtml5({
            "stylesheets": ["/public/global/plugins/bootstrap-wysihtml5/wysiwyg-color.css"]
        });
    }
    ...
    var initFileupload = function () {
        ...
        $('#fileupload').fileupload({
            ...
            url: '/public/global/plugins/jquery-file-upload/server/php/',
            autoUpload: true
        });
    ...
    var loadCompose = function (el) {
        var url = '/public/modules/user_compose.html';
