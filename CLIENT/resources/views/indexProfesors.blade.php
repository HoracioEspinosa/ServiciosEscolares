...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <h1 class="page-title"> Profesores
            <small>Listado de profesores</small>
        </h1>
        <div class="page-bar">
            ...
            <div class="page-toolbar">
                <div class="btn-group pull-right">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                        <li>
                            <a href="#">
                                <i class="fa fa-list"></i> Listar profesores
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fa fa-plus"></i> Agregar profesores
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="icon-refresh"></i> Actualizar profesores
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="inbox-sidebar">
                        <button type="button" class="btn blue btn-block addbtntop"><i class="fa fa-edit"></i>Agregar profesor</button>
                        <ul class="inbox-nav">
                            <li class="active">
                            ...
                            <li>
                                <a href="javascript:;" data-type="draft" data-title="Draft" data-id="2"> Eliminados
                                    <span class="badge badge-danger deletedTotal">0</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:;" data-type="draft" data-title="Draft" data-id="3"> No eliminados
                                    <span class="badge badge-primary nodeletedTotal">0</span>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a href="javascript:;" data-title="Trash" data-id="4"> Activos
                                    <span class="badge badge-info activeTotal">0</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:;" data-type="inbox" data-title="Promotions" data-id="5"> Inactivos
